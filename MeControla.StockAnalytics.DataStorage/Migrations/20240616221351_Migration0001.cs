        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    cmp_cvm_code = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    tck_name = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    tck_isin_code = table.Column<string>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_st_ticker_st_company_CompanyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_st_company_cmp_cvm_code",
                schema: "stocks",
                table: "st_company",
                column: "cmp_cvm_code",
                unique: true);
